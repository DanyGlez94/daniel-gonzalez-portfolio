...
const techLogos = [
  ...
  { name: 'MUI', src: '/icons/mui.svg' },
  { name: 'Ant Design', src: '/icons/antdesign.svg' },
  { name: 'Sass', src: '/icons/sass.svg' },
  { name: 'Figma', src: '/icons/figma.svg' },
  { name: 'Jest', src: '/icons/jest.svg' },
  { name: 'Cypress', src: '/icons/cypress.svg' },
  ...
  { name: 'MariaDB', src: '/icons/mariadb.svg' },
  { name: 'DBeaver', src: '/icons/dbeaver.svg' },
